...
\begin{frame}
  \frametitle{Aspects Of A Typical Presentation}
  \begin{center}
...
\begin{frame}
  ...
  \item Scenario 1a: Editing Code
  \item Scenario 1b: Checking Snippets
  \item Scenario 2a: Downloaded Pictures
  \item Scenario 2b: Generated Pictures
  \item Scenario 3: Continuous Integration
  \end{itemize}
\end{frame}
